...
function censorUrl() {
  let [ episodeNumber, _, seriesName ] = getEpisodeTitleFromEpisodeSite();
...
function censorDocTitle() {
  ...
  const [ episodeNumber, _, seriesName ] = getEpisodeTitleFromEpisodeSite();
...
function censorTitleGeneric( selector ) {
  ...
  elementsWithTitle.forEach(element => {
    ...
    element.textContent = parts.length > 1 ? parts[ 0 ] + " - [Title Censored]" : "[Title Censored]";
  });
